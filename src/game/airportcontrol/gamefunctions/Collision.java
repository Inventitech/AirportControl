...
public class Collision {
	...
	private static boolean areColliding (Airplane o1, Airplane o2){
		
		Point center1 = o1.getPosition();
		Point center2 = o2.getPosition();
		
		int rad1 = Math.max(o1.getImage().getWidth(),o1.getImage().getHeight())/2;
		int rad2 = Math.max(o2.getImage().getWidth(),o2.getImage().getHeight())/2;
