...
public class TestWayfindings {
	...
	@Test public void testAngleBetweenSourceTarget() {
		...
		assertEquals(90, (int)actualAngle, 0);
		
		actualAngle = Wayfinding.calcAngleBetweenSourceTarget(new Point(1,1), new Point(2,2), new Point(3,3));
		assertEquals(0, (int)actualAngle, 0);
		
		actualAngle = Wayfinding.calcAngleBetweenSourceTarget(new Point(1,1), new Point(2,1), new Point(3,2));
		assertEquals(45, (int)actualAngle, 0);
		
		actualAngle = Wayfinding.calcAngleBetweenSourceTarget(new Point(0,0), new Point(5,2), new Point(0,1));
		assertEquals(170, (int)actualAngle, 1);
	}
